    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <h4 class="mb-0 font-size-18">Add New Blog Category | The Abhishek Shrivastav Blog</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?>index.php/admin/dashboard">Home</a></li>
                                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?>index.php/admin/BlogsCategories">Blogs Categories List</a></li>
                                <li class="breadcrumb-item active"><a href="<?php echo base_url(); ?>index.php/admin/BlogsCategories/addCategories">Add Blog Category</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-primary p-4">
                            <h5 class="text-primary">Add New Blog Category on ASB | The Abhishek Shrivastav Blog </h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-3">
                <div class="pt-4 ">
                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/BlogsCategories/addCategories">
                        ...
                        <div class="form-group">
                            <label for="categories_desc">Category Description<span style="color:red;">*</span></label> <input class="form-control" name="categories_desc" value="<?php echo $categories_desc;
                                                                                                                                                                                    ?>" id="categories_desc" placeholder="Category Description">
