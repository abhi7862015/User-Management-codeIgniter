    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="card-body pt-3">
                <div class="pt-4 ">
                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/blogs/editBlog/<?php echo $blog_id; ?>">
                        ...
                        <!-- <div class="form-group">
                            <label for="blog_status">Select Blog Status<span style="color:red;">*</span></label>
                            <select class="form-control" name="blog_status" id="blog_status">
                                <option value="">Select Blog Status</option>
                                <option value="Active" <?php if ($blog_status == 'Active') echo 'selected'; ?>>Active</option>
                                <option value="Inactive" <?php if ($blog_status == 'Inactive') echo 'selected'; ?>>Inactive</option>
                            </select>
                            <span style="color:red; font-size:13px;"><?php echo  form_error('blog_status'); ?></span>
                        </div> -->
                        <br>
