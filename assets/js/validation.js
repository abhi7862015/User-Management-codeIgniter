...
$(function () {
    ...
    var messages = {
        ...
        'price': 'This field is required with max length of 16 & must be in price format e.g. 35.74 or 35.',
        'email': 'This field is required. Allowed format email@example.com',
        ...
        'firstname': 'This field is required & length should be between 1 to 60.',
        'lastname': 'This field is required & length should be between 1 to 60.',
        'middlename': 'Length should be between 1 to 60.',
        ...
        'requiredurl': 'This field is required & length should be between 5 to 2083 & must be a URL.',
        'optionalurl': 'Length should be between 5 to 255 & must be a URL.',
        'carrier': 'Length should be between 2 to 255.',
        'brand': 'Length should be between 2 to 64.',
        'optionalcompany': 'Length should be between 2 to 32.',
        'requiredcompany': 'This field is required & length should be between 2 to 32.',
        'sku': 'Length should be between 2 to 64 and should not contain any special character.',
        'requiredmmddyy': 'This field is required & date should be in mm/dd/yyyy or mm-dd-yyyy format.',
        'optionalmmddyy': 'Date should be in mm/dd/yyyy or mm-dd-yyyy format.',
        'requiredddmmyy': 'This field is required & date should be in dd/mm/yyyy or dd-mm-yyyy format.',
        'optionalddmmyy': 'This field is required & date should be in dd/mm/yyyy or dd-mm-yyyy format.',
        ...
        'requireddocs': 'This field is required & uploaded file should not exceed 2 MB in size and should be in the formats: jpeg, png, jpg, gif, docx, ppt, xlsx.',
        'optionaldocs': 'Uploaded file should not exceed 2 MB in size and should be in the formats: jpeg, png, jpg, gif, docx, ppt, xlsx.',
        'mandatorycolor': 'This field is required & should be a proper color code.',
        'optionalcolor': 'Value should be a proper color code.',
		'maxfieldValue100': 'This field is required & Value should not exceed 100.'
    };
	...
	//Add New Method for - Price - Mandatory + Minimum Length 1 + Maximum Length 16 (Including Decimal Dot & 2 decimal values)
    jQuery.validator.addMethod("maxfieldValue100", function (value, element) {
        if ($.trim(value) == "" || value > 100 ) {
            return false;
        } else {
            return true;
        }
    }, messages.maxfieldValue100);
